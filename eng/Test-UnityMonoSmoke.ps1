...
Require-Text $managedLog "Unity main-thread pump installed."
Require-Text $managedLog "INSIDER_UNITY_MONO_SMOKE_MAIN_THREAD_CALLBACK"
Require-Text $managedLog "INSIDER_UNITY_MONO_SMOKE_UPDATE_CALLBACK"
Require-Text $managedLog "INSIDER_UNITY_MONO_SMOKE_GAME_IL_HOOK_INSTALLED"
...
Require-Text (Join-Path $insiderDirectory "unity-smoke-main-thread.txt") "IsReady=True"
Require-Text (Join-Path $insiderDirectory "unity-smoke-main-thread.txt") "IsCurrent=True"
Require-Text (Join-Path $insiderDirectory "unity-smoke-main-thread.txt") "SynchronizationContext=UnityEngine.UnitySynchronizationContext"
Require-Text (Join-Path $insiderDirectory "unity-smoke-main-thread.txt") "ApplicationIsPlaying=True"
Require-Text (Join-Path $insiderDirectory "unity-smoke-update.txt") "UpdateCount=3"
Require-Text (Join-Path $insiderDirectory "unity-smoke-update.txt") "IsCurrent=True"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooked.txt") "GameHookAssembly=Assembly-CSharp"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooked.txt") "GameHookCount=3"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooked.txt") "GameDetourCount=2"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooked.txt") "GameIlHookCount=1"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooked.txt") "GameHookedValue=42"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooked.txt") "GameIlHookedValue=42"
...
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooks-removed.txt") "GameIlHookCount=0"
Require-Text (Join-Path $insiderDirectory "unity-smoke-game-hooks-removed.txt") "GameIlRestoredValue=7"
...
Require-Text $playerLog "INSIDER_UNITY_MONO_SMOKE_GAME_IL_HOOKED_VALUE=42"
Require-Text $playerLog "INSIDER_UNITY_MONO_SMOKE_GAME_IL_RESTORED_VALUE=7"
